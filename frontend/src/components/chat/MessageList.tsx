...
export default function MessageList({ messages, isLoading, onExampleClick }: MessageListProps) {
  return (
    <Box
      sx={{
        flex: 1,
      ...
      {messages.length === 0 && (
        <Box sx={{ textAlign: 'center', mt: 6, mb: 4 }}>
          <Box sx={{ display: 'flex', justifyContent: 'center', mb: 2 }}>
            <TrendingUpIcon sx={{ fontSize: 48, color: 'primary.main', opacity: 0.8 }} />
          </Box>
          ...
          >
            Ask me to generate bar or line charts from your data. I'll analyze your request and
