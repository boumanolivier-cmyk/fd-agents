...
TEST_CASES = [
    ...
    (
        "Can you make a line chart for this data: 2020=25, 2021=26, 2022=26.5",
        True,
        "concrete_data",
        None,
    ),
    ...
    (
        "I need a bar chart with North=500, South=750, East=600, West=550",
        True,
        "explicit_with_data",
        None,
    ),
    (
        "Create a line chart showing: 2020=10, 2021=15, 2022=20, 2023=25",
        True,
        "explicit_with_data",
        None,
    ),
    ...
    (
        "Show me stock prices: Monday=150, Tuesday=155, Wednesday=148, Thursday=152",
        True,
        "concrete_data",
        "fd",
    ),
    ...
    (
        "Make a chart of investment returns: Fund A=8.5%, Fund B=7.2%, Fund C=9.1%",
        True,
        "concrete_data",
        "fd",
    ),
    ...
    (
        "Chart BNR listener numbers: Monday=50K, Tuesday=52K, Wednesday=48K, Thursday=55K",
        True,
        "concrete_data",
        "bnr",
    ),
    (
        "Show me news broadcast ratings: Morning=125K, Afternoon=95K, Evening=180K",
        True,
        "concrete_data",
        "bnr",
    ),
    (
        "Create a chart of radio show popularity: Show A=75, Show B=82, Show C=68",
        True,
        "concrete_data",
        "bnr",
    ),
