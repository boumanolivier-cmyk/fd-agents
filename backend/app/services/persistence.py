...
class PersistenceService:
    ...
    def __init__(
        self, session_file: Path = settings.SESSION_FILE, memory_file: Optional[Path] = None
    ):
    ...
    def create_or_update_session(
        self, session_id: str, style: Literal["fd", "bnr"] = "fd"
    ) -> SessionData:
        ...
        if session_id in sessions:
            ...
            sessions[session_id] = SessionData(
                session_id=session_id, style=style, created_at=now, last_used=now, chat_history=[]
            )
    ...
    def set_style_preference(self, session_id: str, style: Literal["fd", "bnr"]) -> SessionData:
    ...
    def add_to_chat_history(
        ...
        message: ChatMessage = ChatMessage(
            role=role, content=content, timestamp=datetime.now().isoformat(), metadata=metadata
        )
