...
class ChartData(BaseModel):
    ...
    chart_type: Optional[Literal["bar", "line"]] = Field(
        None, description="Type of chart to generate"
    )
    ...
    color_scheme: Optional[Literal["fd", "bnr"]] = Field(
        None, description="Color scheme determined by context"
    )
...
class ChatResponse(BaseModel):
    ...
    color_scheme: Optional[Literal["fd", "bnr"]] = Field(
        None, description="Color scheme used for the chart"
    )
